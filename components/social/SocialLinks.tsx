        ...
        >
          ...
          >
            <motion.div
              ...
              whileTap={{ scale: 0.95 }}
              className="w-10 h-10 rounded-lg bg-foreground/10 hover:bg-gradient-tech flex items-center justify-center text-foreground/80 hover:text-white transition-all duration-300 group-hover:shadow-lg group-hover:shadow-accent-primary/50"
            >
              {link.icon}
            </motion.div>
          </Link>
